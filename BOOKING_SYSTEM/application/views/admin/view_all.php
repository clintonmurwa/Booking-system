...
<li class="nav-item">
  <a class="nav-link collapsed" href="<?= base_url('user/logout'); ?>">
    ...
    <div id="sendrep" class="container mt-4">
    <form action="<?php echo site_url('admin/send_slots_report'); ?>" method="post">
    ...
    <div id="slots" class="container mt-4">
    ...
    <br/>
    <a href="<?= base_url('admin/add_slot'); ?>" class="btn btn-primary mb-3">Add New Slot</a>
            ...
            <tbody>
                <?php foreach ($slots as $slot): ?>
                    <tr>
                        ...
                        <td><?= $slot['end_time']; ?></td>
                        <td>
                    <!-- Display booked or available status -->
                    <?= $slot['available'] ? '<span class="text-success">Available</span>' : '<span class="text-danger">Booked</span>'; ?>
                </td>
                        <td>
                            <a href="<?= base_url('admin/edit_slot/' . $slot['id']); ?>" class="btn btn-warning btn-sm">Edit</a>
                            <a href="<?= base_url('admin/delete_slot/' . $slot['id']); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure?');">Delete</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
