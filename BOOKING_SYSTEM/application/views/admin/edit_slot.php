...
<li class="nav-item">
    ...
    <div class="container mt-4">
        <h2>Edit Slot</h2>
        <?= form_open('admin/edit_slot/' . $slot['id']); ?>
            <div class="form-group">
                <label for="slot_number">Slot Number</label>
                <input type="text" name="slot_number" class="form-control" id="slot_number" value="<?= $slot['slot_number']; ?>">
            </div>
            <div class="form-group">
                <label for="start_time">Start Time</label>
                <input type="datetime-local" name="start_time" class="form-control" id="start_time" value="<?= date('Y-m-d\TH:i', strtotime($slot['start_time'])); ?>">
            </div>
            <div class="form-group">
                <label for="end_time">End Time</label>
                <input type="datetime-local" name="end_time" class="form-control" id="end_time" value="<?= date('Y-m-d\TH:i', strtotime($slot['end_time'])); ?>">
            </div>
