...
<a class="nav-link collapsed" href="<?= base_url('user/logout'); ?>">
  ...
  <body>
    ...
    <!-- Main content -->
    <div class="container mt-5"class="container m-5 main" id="main">
        ...
        <div class="col-md-8">
          <div class="card">
            <div class="card-header">
              <h3 class="text-center">Add Personal Details</h3>
            </div>
            <div class="card-body">
              <form method="post" action="<?= base_url('user/add_details'); ?>">
                <div class="mb-3">
