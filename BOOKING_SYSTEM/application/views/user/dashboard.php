...
<a class="nav-link collapsed" href="<?= base_url('user/logout'); ?>">
  ...
  <div class="container mt-5 main d-flex justify-content-center align-items-center" id="main">
    <div class="card text-center shadow-lg">
        <div class="card-header bg-success text-white">
            <h3>Welcome, User!</h3>
        </div>
        <div class="card-body">
            <h5 class="card-title">Hello, <?php echo $this->session->userdata('username'); ?>!</h5>
            <p class="card-text">
                We’re glad to see you back. Explore your dashboard, check updates, and manage your activities seamlessly.
            </p>
        </div>
