...
<tbody>
    <?php if (empty($slots)): ?>
        <tr>
            <td colspan="6" class="text-center text-muted py-4">
                ...
                <strong>No slots available at the moment.</strong>
        ...
        <?php foreach ($slots as $slot): ?>
            <tr>
                <td class="align-middle text-primary">
                    <i class="bi bi-grid"></i> <?= $slot['slot_number']; ?>
                </td>
                <td class="align-middle">
                    <i class="bi bi-person-circle"></i> <?= $slot['created_by']; ?>
                </td>
                <td class="align-middle">
                    <i class="bi bi-clock"></i> <?= $slot['start_time']; ?>
                </td>
                <td class="align-middle">
                    <i class="bi bi-clock-fill"></i> <?= $slot['end_time']; ?>
                </td>
                <td class="align-middle">
                    <!-- Add a form for each slot -->
                    <form action="<?= base_url('user/make_booking/'.$slot['id']); ?>" method="POST">
    ...
    <?php endif; ?>
        ...
        <a href="<?= base_url('user/view_bookings'); ?>" class="btn btn-secondary">View My Bookings</a>
    </div>
