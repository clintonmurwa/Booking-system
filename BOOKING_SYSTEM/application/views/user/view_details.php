            ...
            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <strong>Full Name:</strong> <?= htmlspecialchars($details['full_name']) ?>
                    </div>
                    <div class="col-md-6 mb-3">
                        <strong>Date of Birth:</strong> <?= htmlspecialchars($details['dob']) ?>
                    </div>
                    <div class="col-md-6 mb-3">
                        <strong>ID Number:</strong> <?= htmlspecialchars($details['IDno']) ?>
                    </div>
                    <div class="col-md-6 mb-3">
                        <strong>Contact Number:</strong> <?= htmlspecialchars($details['contact_number']) ?>
                    </div>
                    <div class="col-md-6 mb-3">
                        <strong>Address:</strong> <?= htmlspecialchars($details['address']) ?>
                    </div>
                    <div class="col-md-6 mb-3">
                        <strong>Nationality:</strong> <?= htmlspecialchars($details['nationality']) ?>
                    </div>
                    <div class="col-md-6 mb-3">
                        <strong>Occupation:</strong> <?= htmlspecialchars($details['occupation']) ?>
                    </div>
                    <div class="col-md-6 mb-3">
                        <strong>Emergency Contact:</strong> <?= htmlspecialchars($details['emergency_contact']) ?>
                    </div>
                    <div class="col-md-12 mb-3">
                    <h5 class="card-title">Medical Conditions:</h5>
                    <p class="small fst-italic"> <?= htmlspecialchars($details['medical_conditions']) ?></p>
                    </div>
                </div>
            </div>
        </div>
